...
function exportRevenue(){
  ...
  const q=v=>'"'+String(v??'').replace(/"/g,'""')+'"';
  const rows=[['Metric','Value'],['Gross revenue',gross],['Fees',h.fees||0],['Catalog fees',h.catalogFees||0],['Cup rakes',h.cupRakes||0],['Tournament rakes',h.trnyRakes||0],['Shop/commerce',h.shop||0],['Transfer fees',h.xfFees||0],['Promo cost',h.promoCost||0],['Comps',h.comps||0],['Net revenue (NGR)',net],['Cash in — player deposits',h.deposits||0],['Cash in — bot deposits',h.botDeposits||0],['Cash in total',cin],['Cash out — bot withdrawals',h.withdrawals||0],['Cash out — player withdrawals',h.playerWithdrawals||0],['Cash out total',cout],['Net cash flow',ncash],['Taps (created)',cfg().taps||0],['Sinks (removed)',cfg().sinks||0],['House capital',h.capital||0],['House bankroll',(h.capital||0)+net]];
