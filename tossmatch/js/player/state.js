...
function defaultState(){
  ...
  return {
    ...
    owned:{skins:["classic"],flags:[],avatars:[],frames:["none"],colours:["default"],fx:["confetti"],themes:["midnight"],sounds:["standard"],emojis:[],cardbacks:["classic"]},
    equipped:{skin:"classic",flag:"",avatar:"",frame:"none",colour:"default",fx:"confetti",theme:"midnight",sound:"standard",cardBack:"classic"},
    games:[],reactions:{},
    ...
    engagement:{battlePass:{month:"",xp:0,premium:false,claimedFree:[],claimedPremium:[]},weekly:{key:"",wins:0,games:0,gameTypes:{},bestStreak:0,claimed:[]},prestige:0,skillOnly:false,milestones:{claimed:{}},missions:{day:"",claimed:[]},badges:[]},
    economyPlus:{cratesOpened:0,tradingListings:[],staking:{balance:0,lastClaim:Date.now()},subscription:{tier:"none",expires:0,lastDropMonth:""},boosters:{xpUntil:0,rakeUntil:0},utility:{crafts:[],eventTickets:0,ticketPurchases:[],clanTreasury:0,clanLevel:1,roomUpgrade:'basic',roomPurchases:[]},auction:{weekKey:"",lots:[],history:[]},bonds:{principal:0,coupon:0,nextCoupon:Date.now(),buys:[]},mine:{energy:20,digs:0,shards:0,last:Date.now(),log:[]},exchange:{day:"",today:0,log:[]}},
    vipPlus:{daily:{day:"",claimed:0,tier:0},quest:{month:"",claimed:0,reward:0},road:{claimed:[]}},
    seasonPlus:{faction:"",points:0,missions:{key:"",claimed:[]},prizes:{key:"",claimed:[]},history:[]},
    spectatorEvents:[],
    lossLimit:0,
...
function load(){
  try{
    ...
    if(r){
      ...
      S.engagement=Object.assign(defaultState().engagement,p.engagement||{});S.engagement.battlePass=Object.assign(defaultState().engagement.battlePass,(p.engagement&&p.engagement.battlePass)||{});S.engagement.weekly=Object.assign(defaultState().engagement.weekly,(p.engagement&&p.engagement.weekly)||{});S.engagement.milestones=Object.assign(defaultState().engagement.milestones,(p.engagement&&p.engagement.milestones)||{});S.engagement.missions=Object.assign(defaultState().engagement.missions,(p.engagement&&p.engagement.missions)||{});S.engagement.badges=Array.isArray(p.engagement&&p.engagement.badges)?p.engagement.badges:[];
      S.economyPlus=Object.assign(defaultState().economyPlus,p.economyPlus||{});S.economyPlus.staking=Object.assign(defaultState().economyPlus.staking,(p.economyPlus&&p.economyPlus.staking)||{});S.economyPlus.subscription=Object.assign(defaultState().economyPlus.subscription,(p.economyPlus&&p.economyPlus.subscription)||{});S.economyPlus.boosters=Object.assign(defaultState().economyPlus.boosters,(p.economyPlus&&p.economyPlus.boosters)||{});S.economyPlus.utility=Object.assign(defaultState().economyPlus.utility,(p.economyPlus&&p.economyPlus.utility)||{});S.economyPlus.auction=Object.assign(defaultState().economyPlus.auction,(p.economyPlus&&p.economyPlus.auction)||{});if(!Array.isArray(S.economyPlus.auction.lots))S.economyPlus.auction.lots=[];if(!Array.isArray(S.economyPlus.auction.history))S.economyPlus.auction.history=[];S.economyPlus.bonds=Object.assign(defaultState().economyPlus.bonds,(p.economyPlus&&p.economyPlus.bonds)||{});S.economyPlus.mine=Object.assign(defaultState().economyPlus.mine,(p.economyPlus&&p.economyPlus.mine)||{});S.economyPlus.exchange=Object.assign(defaultState().economyPlus.exchange,(p.economyPlus&&p.economyPlus.exchange)||{});
      S.vipPlus=Object.assign(defaultState().vipPlus,p.vipPlus||{});S.vipPlus.daily=Object.assign(defaultState().vipPlus.daily,(p.vipPlus&&p.vipPlus.daily)||{});S.vipPlus.quest=Object.assign(defaultState().vipPlus.quest,(p.vipPlus&&p.vipPlus.quest)||{});S.vipPlus.road=Object.assign(defaultState().vipPlus.road,(p.vipPlus&&p.vipPlus.road)||{});
      S.seasonPlus=Object.assign(defaultState().seasonPlus,p.seasonPlus||{});S.seasonPlus.missions=Object.assign(defaultState().seasonPlus.missions,(p.seasonPlus&&p.seasonPlus.missions)||{});S.seasonPlus.prizes=Object.assign(defaultState().seasonPlus.prizes,(p.seasonPlus&&p.seasonPlus.prizes)||{});
