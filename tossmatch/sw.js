const CACHE='tossmatch-v11.0';
const CORE=['./','./index.html','./admin.html','./manifest.webmanifest','./icons/favicon.png','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-512.jpg','./img/logo.jpg','./img/coin-heads.jpg','./img/coin-tails.jpg','./api/openapi.json'];
